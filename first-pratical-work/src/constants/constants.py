class Constants:
    ...
    def texts(self):
        ...
        # 1 ou 2
        evaluate_number_in_str =  '1' if alternative == 'a' or alternative == 'b' else '2'
        ...
        # HC_1_a
        final_file_name = evaluate_number_in_str + '/' +self.algorithm + '-' + evaluate_number_in_str + '-' + alternative
